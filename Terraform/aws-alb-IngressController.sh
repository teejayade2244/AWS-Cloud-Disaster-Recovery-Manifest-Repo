...
aws eks update-kubeconfig --region us-west-2 --name your-secondary-cluster-name
...
helm install aws-load-balancer-controller eks/aws-load-balancer-controller \
  -n kube-system \
  --set clusterName=your-primary-cluster-name \
  ...
  --set serviceAccount.annotations."eks\.amazonaws\.com/role-arn"=arn:aws:iam::ACCOUNT-ID:role/your-primary-cluster-name-alb-ingress-controller-role
